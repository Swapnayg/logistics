...
const StockManageList = () => {

  const [stockId, setId] = useState(0);
    ...
    fetch('http://localhost:5000/inv_stock_data'+'/'+localStorage.getItem('id')).then((res) =>
      res.json().then((jsdata) => {
       for (let i = 0; i < jsdata.stock_data.length; i++) {
            let row = '<tr>';
            row += '<td>' + (i +1) + '</td>';
            row += '<td style="text-transform:capitalize">' + jsdata.stock_data[i].stock_num + '</td>';
            row += '<td style="text-transform:capitalize">' + jsdata.stock_data[i].supplier_name + '</td>';
            row += '<td style="text-transform:capitalize">' + moment(jsdata.stock_data[i].stock_date).format("DD/MM/YYYY") + '</td>';
            row += '<td style="text-transform:capitalize">' + "Rs. "+numberWithCommas(jsdata.stock_data[i].grand_total) + '</td>';
            if(jsdata.stock_data[i].stock_status.toString().trim() == "partial")
            {
              row += '<td style="text-transform:capitalize;"><span class="bg-warning-focus text-warning-main px-24 py-4 rounded-pill fw-medium text-sm" style="font-size: 12px !important;">Posted</span></td>';
            }
            else if(jsdata.stock_data[i].stock_status.toString().trim() == "paid")
            {
            ...
            else if(jsdata.stock_data[i].stock_status.toString().trim() == "pending")
            {
              row += '<td style="text-transform:capitalize;"><span class="bg-danger-focus text-danger-main px-24 py-4 rounded-pill fw-medium text-sm" style="font-size: 12px !important;">pending</span></td>';
            }
            row += '<td ><a class="stock_view w-32-px h-32-px  me-8 bg-primary-light text-primary-600 rounded-circle d-inline-flex align-items-center justify-content-center"  data-lable='+jsdata.stock_data[i].id+' data-type="supplier" ><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--hugeicons menu-icon" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" color="currentColor"><path d="M21.544 11.045c.304.426.456.64.456.955c0 .316-.152.529-.456.955C20.178 14.871 16.689 19 12 19c-4.69 0-8.178-4.13-9.544-6.045C2.152 12.529 2 12.315 2 12c0-.316.152-.529.456-.955C3.822 9.129 7.311 5 12 5c4.69 0 8.178 4.13 9.544 6.045"></path><path d="M15 12a3 3 0 1 0-6 0a3 3 0 0 0 6 0"></path></g></svg></a><a class="stock_edit w-32-px h-32-px me-8 bg-success-focus text-success-main rounded-circle d-inline-flex align-items-center justify-content-center" data-lable='+jsdata.stock_data[i].id+'  data-type="supplier"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--lucide" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.375 2.625a1 1 0 0 1 3 3l-9.013 9.014a2 2 0 0 1-.853.505l-2.873.84a.5.5 0 0 1-.62-.62l.84-2.873a2 2 0 0 1 .506-.852z"></path></g></svg></a><a class="stock_delete w-32-px h-32-px me-8 bg-danger-focus text-danger-main rounded-circle d-inline-flex align-items-center justify-content-center" data-lable='+jsdata.stock_data[i].id+'  data-type="supplier"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--mingcute" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none"><path d="m12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035q-.016-.005-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.017-.018m.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093q.019.005.029-.008l.004-.014l-.034-.614q-.005-.018-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01z"></path><path fill="currentColor" d="M14.28 2a2 2 0 0 1 1.897 1.368L16.72 5H20a1 1 0 1 1 0 2l-.003.071l-.867 12.143A3 3 0 0 1 16.138 22H7.862a3 3 0 0 1-2.992-2.786L4.003 7.07L4 7a1 1 0 0 1 0-2h3.28l.543-1.632A2 2 0 0 1 9.721 2zm3.717 5H6.003l.862 12.071a1 1 0 0 0 .997.929h8.276a1 1 0 0 0 .997-.929zM10 10a1 1 0 0 1 .993.883L11 11v5a1 1 0 0 1-1.993.117L9 16v-5a1 1 0 0 1 1-1m4 0a1 1 0 0 1 1 1v5a1 1 0 1 1-2 0v-5a1 1 0 0 1 1-1m.28-6H9.72l-.333 1h5.226z"></path></g></svg></a></td>';
            row += '</tr>';
            $("#stock_table tbody").append(row);
       }
       for (let i = 0; i < jsdata.cust_data.length; i++) {
        let row = '<tr>';
        row += '<td>' + (i +1) + '</td>';
        row += '<td style="text-transform:capitalize">' + jsdata.cust_data[i].stock_num + '</td>';
        row += '<td style="text-transform:capitalize">' + jsdata.cust_data[i].client_name + '</td>';
        row += '<td style="text-transform:capitalize">' + moment(jsdata.cust_data[i].stock_date).format("DD/MM/YYYY") + '</td>';
        row += '<td style="text-transform:capitalize">' + "Rs. "+numberWithCommas(jsdata.cust_data[i].grand_total) + '</td>';
        if(jsdata.cust_data[i].stock_status.toString().trim() == "partial")
        {
          row += '<td style="text-transform:capitalize;"><span class="bg-warning-focus text-warning-main px-24 py-4 rounded-pill fw-medium text-sm" style="font-size: 12px !important;">Posted</span></td>';
        }
        else if(jsdata.cust_data[i].stock_status.toString().trim() == "paid")
        {
          row += '<td style="text-transform:capitalize;"><span class="bg-success-focus text-success-main px-24 py-4 rounded-pill fw-medium text-sm" style="font-size: 12px !important;">Paid</span></td>';
        }
        else if(jsdata.cust_data[i].stock_status.toString().trim() == "pending")
        {
          row += '<td style="text-transform:capitalize;"><span class="bg-danger-focus text-danger-main px-24 py-4 rounded-pill fw-medium text-sm" style="font-size: 12px !important;">pending</span></td>';
        }
        row += '<td ><a class="stock_view w-32-px h-32-px  me-8 bg-primary-light text-primary-600 rounded-circle d-inline-flex align-items-center justify-content-center"  data-lable='+jsdata.cust_data[i].id+'  data-type="client" ><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--hugeicons menu-icon" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" color="currentColor"><path d="M21.544 11.045c.304.426.456.64.456.955c0 .316-.152.529-.456.955C20.178 14.871 16.689 19 12 19c-4.69 0-8.178-4.13-9.544-6.045C2.152 12.529 2 12.315 2 12c0-.316.152-.529.456-.955C3.822 9.129 7.311 5 12 5c4.69 0 8.178 4.13 9.544 6.045"></path><path d="M15 12a3 3 0 1 0-6 0a3 3 0 0 0 6 0"></path></g></svg></a><a class="stock_edit w-32-px h-32-px me-8 bg-success-focus text-success-main rounded-circle d-inline-flex align-items-center justify-content-center" data-lable='+jsdata.cust_data[i].id+' data-type="client"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--lucide" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.375 2.625a1 1 0 0 1 3 3l-9.013 9.014a2 2 0 0 1-.853.505l-2.873.84a.5.5 0 0 1-.62-.62l.84-2.873a2 2 0 0 1 .506-.852z"></path></g></svg></a><a class="stock_delete w-32-px h-32-px me-8 bg-danger-focus text-danger-main rounded-circle d-inline-flex align-items-center justify-content-center" data-lable='+jsdata.cust_data[i].id+' data-type="client"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--mingcute" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none"><path d="m12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035q-.016-.005-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.017-.018m.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093q.019.005.029-.008l.004-.014l-.034-.614q-.005-.018-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01z"></path><path fill="currentColor" d="M14.28 2a2 2 0 0 1 1.897 1.368L16.72 5H20a1 1 0 1 1 0 2l-.003.071l-.867 12.143A3 3 0 0 1 16.138 22H7.862a3 3 0 0 1-2.992-2.786L4.003 7.07L4 7a1 1 0 0 1 0-2h3.28l.543-1.632A2 2 0 0 1 9.721 2zm3.717 5H6.003l.862 12.071a1 1 0 0 0 .997.929h8.276a1 1 0 0 0 .997-.929zM10 10a1 1 0 0 1 .993.883L11 11v5a1 1 0 0 1-1.993.117L9 16v-5a1 1 0 0 1 1-1m4 0a1 1 0 0 1 1 1v5a1 1 0 1 1-2 0v-5a1 1 0 0 1 1-1m.28-6H9.72l-.333 1h5.226z"></path></g></svg></a></td>';
        row += '</tr>';
        $("#stock_table tbody").append(row);
      }
  ...
  const handleDownload = (e) => {
    ...
    $(document).off('click', '.stock_view').on("click", '.stock_view', function(e){
      e.preventDefault();
      ...
      $('#tbl_view_order tbody').empty();
        ...
        fetch('http://localhost:5000/get_stk_return_data', { 
          ...
          setv_Inv_Id(data.stk_rtn_data.id);
          setv_Inv_Num(data.stk_rtn_data.stock_num);
          setv_Inv_Date(moment(data.stk_rtn_data.stock_date.toString().trim()).format("DD/MM/YYYY"));
          setv_Inv_Due_Dt(moment(data.stk_rtn_data.stock_due_date.toString().trim()).format("DD/MM/YYYY"));
          setv_Inv_Ref(data.stk_rtn_data.stock_refer);
          if(data.stk_rtn_data.payment_terms.toString().trim()=="receipt")
          {
            setv_Inv_Term("Payment Due on Receipt");
          }
          setv_Inv_Shipp(data.stk_rtn_data.shipping);
          ...
          else if(row_type == "client")
          {
            setv_Inv_Cus_Name(data.suppl_data.client_name);
            setv_Inv_Cus_Addrs(data.suppl_data.client_address);
            setv_Inv_Cus_Cnty(data.suppl_data.client_country);
            setv_Inv_Cus_City(data.suppl_data.client_city);
            setv_Inv_Cus_Phone(data.suppl_data.client_phone.toString().trim());
            setv_Inv_Cus_Email(data.suppl_data.client_email);       
          }
          setv_Inv_SubTotal(parseFloat(data.stk_rtn_data.grand_total).toFixed(2) - parseFloat(data.stk_rtn_data.shipping).toFixed(2));
          setv_Inv_TotalTax(data.stk_rtn_data.total_tax);
          setv_Inv_TotalDisc(data.stk_rtn_data.total_discount);
          setv_Inv_Total(data.stk_rtn_data.grand_total);
          for (let k = 0; k < data.stk_rtn_items.length; k++) {
            var row_id = data.stk_rtn_items[k].id;
            var item_name =data.stk_rtn_items[k].item_name;
            var item_rate = data.stk_rtn_items[k].item_rate;
            var item_qty = data.stk_rtn_items[k].item_qnty;
            var item_tax = data.stk_rtn_items[k].item_tax;
            var item_disc = data.stk_rtn_items[k].item_disc_val;
            var item_amt = data.stk_rtn_items[k].item_amount;
      ...
      if($("#btnordersubmit").text().trim() == "Update")
      {
        ...
        fetch('http://localhost:5000/update_stk_return_values', { 
          ...
          headers: {   'Accept': 'application/json',
            ...
            body: JSON.stringify({userid:localStorage.getItem('id'),o_type:rowType, o_stockId:stockId, o_warehouse: Warehouse.toString().trim(), o_invoiceNm :OInvoiceNo.toString().trim(), o_invoiceRef: ORefNo.toString().trim(), a_OInvDate: Date(OInvDate.toString().trim()), o_OInvDueDate: OInvDueDate, o_OInvTax: OInvTax.toString().trim(), o_OInvDisc: OInvDisc.toString().trim(), o_OInvNote: OInvNote.toString().trim(), o_OInvTotax: OInvTotax.toString().trim(), o_OInvDist:OInvDist.toString().trim(), o_OInvShipp:OInvShipp.toString().trim(), o_OInvGrnTotal:OInvGrnTotal.toString().trim(),OInvTotal:OInvTotal.toString().trim(), o_payment_due:payment_due.toString().trim(),o_update_stk:update_stk.toString().trim(), o_items : ord_items})
          }).then(res => {
              return res.json();
          }).then(data => {
          if(parseInt(data) != 0)
...
$(document).off('click', '.stock_edit').on("click", '.stock_edit', function(e){
  e.preventDefault();
  var row_id = $(this).attr("data-lable");
  var row_type = $(this).attr("data-type");
  if(row_type == "supplier")
  ...
  setedithidden(false);
    ...
    fetch('http://localhost:5000/get_stk_return_data', { 
      ...
      const due_date = new Date(data.stk_rtn_data.stock_due_date.toString().trim());
      setId(data.stk_rtn_data.id);
      setOInvoiceNo(data.stk_rtn_data.stock_num);
      setOInvDate(moment(data.stk_rtn_data.stock_date).format("DD/MM/YYYY"));
      setOInvDueDate(due_date);
      setupdate_stk(data.stk_rtn_data.update_stock.toString().trim());
      setORefNo(data.stk_rtn_data.stock_refer.toString().trim());
      if(data.stk_rtn_data.payment_terms.toString().trim()=="receipt")
      {
        setpayment_due(data.stk_rtn_data.payment_terms.toString());
      }
      if(row_type == "supplier")
        {
          setsupplName(data.suppl_data.suppl_name);
          setsupplAddss(data.suppl_data.suppl_address);
          setsupplCountry(data.suppl_data.client_country);
        ...
        {
          setsupplName(data.suppl_data.client_name);
          setsupplAddss(data.suppl_data.client_address);
          setsupplCountry(data.suppl_data.client_country);
          setsupplCity(data.suppl_data.client_city);
          setsupplPhone(data.suppl_data.client_phone.toString().trim());
          setsupplEmail(data.suppl_data.client_email);       
        }
      setOInvTax(data.stk_rtn_data.stock_tax.toString());
      setOInvDisc(data.stk_rtn_data.stock_discount.toString());
      setOInvShipp(data.stk_rtn_data.shipping);
      setsupplhidden(false);
      setOInvTotal(parseFloat(data.stk_rtn_data.grand_total).toFixed(2) - parseFloat(data.stk_rtn_data.shipping).toFixed(2));
      setOInvTotax(data.stk_rtn_data.total_tax);
      setOInvDist(data.stk_rtn_data.total_discount);
      setOInvGrnTotal(data.stk_rtn_data.grand_total);
      setOInvNote(data.stk_rtn_data.stock_note);
      setWarehouse(data.stk_rtn_data.warehouse_id);
      setWarehouseName(data.stk_rtn_data.warehouse_name);
      var sel_Array = [];
      for (let k = 0; k < data.stk_rtn_items.length; k++) {
        var row_id = data.stk_rtn_items[k].item_product;
        sel_Array.push(parseInt(row_id)); 
        var tbl_row = $("#add_item_table tbody tr.main_row").length + 1;
        var tbl_row_indx = $("#add_item_table tbody tr").length;
        var item_name =data.stk_rtn_items[k].item_name;
        var item_rate = data.stk_rtn_items[k].item_rate;
        var item_qty = data.stk_rtn_items[k].item_qnty;
        var item_per_tax = data.stk_rtn_items[k].item_per_tax;
        var item_tax = data.stk_rtn_items[k].item_tax;
        var item_disc = data.stk_rtn_items[k].item_disc;
        var item_disc_val = data.stk_rtn_items[k].item_disc_val;
        var item_amt = data.stk_rtn_items[k].item_amount;
        var item_descp = data.stk_rtn_items[k].item_description;
  ...
  $(document).off('click', '.stock_delete').on("click", '.stock_delete', function(e){
    e.preventDefault();
    var row_id = $(this).attr("data-lable");
    var row_type = $(this).attr("data-type");
    setId(row_id);
  ...
  return (
    <div>
       <div className="col-lg-12">
            ...
            <div className="card-header">
              <h5 className="card-title mb-0">Update Stock Return</h5>
            </div>
            <div className='card-header'>
   ...
   <div className="card-body">
            ...
            <div className="col-md-5">
             <div className="col-md-12 mb-3">
                ...
                <div className="col-md-12" >
                  ...
                  <label className="form-label mb-0">{rowType} Details</label>
                  </div>
    ...
    <div className="card basic-data-table" hidden={listhidden}>
      <div className="card-header">
        <h5 className="card-title mb-0">Stock Return List</h5>
      </div>
      <div className="card-body">
        <table
